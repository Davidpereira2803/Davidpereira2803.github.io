...
\leftheader{%
  {\LARGE\bfseries\sffamily PEREIRA DE MAGALHAES David}

  \makefield{\faEnvelope[regular]}{\href{perda2803@gmail.com}{\texttt{perda2803@gmail.com}}}
  
  \makefield{\faPhone[regular]}
  {\texttt{+352 691 244 236}}
  
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/davidpereira2803/}{\texttt{David Pereira}}}

   \makefield{\faGithub}
  {\href{https://github.com/Davidpereira2803}{\texttt{Davidpereira2803}}}

  \makefield{\faGlobe}
  {\href{https://davidpereira2803.github.io/}{\texttt{Project Portfolio}}}


    \makefield{\faHome}
    {\texttt{63, Rue Joseph Philippart Rodange L-4845 (Luxembourg)}}
    
    \makefield{\faAngleRight}
    {\texttt{Born on the 28/03/2003 in Niedercorn}}
...
\begin{document}
\makeheaders[c]
    Computer Science student passionate about Artificial Intelligence and secure systems. Previous experiences in web development, robotics and academic research, with strong multilingual communication skills.
